...
const expansionCities = [
  { name: "New York City", abbr: "NYC", silhouette: "M10,60 L10,30 L15,30 L15,20 L20,20 L20,15 L25,15 L25,20 L30,20 L30,10 L35,10 L35,20 L40,20 L40,25 L45,25 L45,30 L50,30 L50,60 Z" },
  { name: "Philadelphia", abbr: "PHL", silhouette: "M10,60 L10,35 L18,35 L18,28 L22,28 L22,22 L26,22 L26,18 L30,18 L30,22 L34,22 L34,28 L38,28 L38,35 L46,35 L46,60 Z" },
  { name: "Chicago", abbr: "CHI", silhouette: "M8,60 L8,32 L14,32 L14,22 L19,22 L19,16 L24,16 L24,12 L29,12 L29,16 L34,16 L34,22 L39,22 L39,32 L45,32 L45,60 Z" },
  { name: "Boston", abbr: "BOS", silhouette: "M10,60 L10,38 L16,38 L16,30 L20,30 L20,24 L25,24 L25,28 L30,28 L30,22 L35,22 L35,28 L40,28 L40,38 L45,38 L45,60 Z" },
  { name: "Phoenix", abbr: "PHX", silhouette: "M8,60 L8,42 L16,42 L16,36 L22,36 L22,30 L28,30 L28,36 L34,36 L34,30 L40,30 L40,36 L46,36 L46,42 L52,42 L52,60 Z" },
  { name: "Los Angeles", abbr: "LAX", silhouette: "M6,60 L6,40 L12,40 L12,34 L18,34 L18,28 L24,28 L24,22 L30,22 L30,28 L36,28 L36,22 L42,22 L42,28 L48,28 L48,34 L54,34 L54,60 Z" },
  { name: "San Francisco", abbr: "SFO", silhouette: "M10,60 L10,44 L15,44 L15,36 L20,36 L20,28 L25,28 L25,20 L30,20 L30,14 L35,14 L35,20 L40,20 L40,28 L45,28 L45,36 L50,36 L50,44 L55,44 L55,60 Z" },
  { name: "San Diego", abbr: "SAN", silhouette: "M10,60 L10,40 L16,40 L16,34 L22,34 L22,26 L28,26 L28,34 L34,34 L34,26 L40,26 L40,34 L46,34 L46,40 L52,40 L52,60 Z" },
  { name: "Denver", abbr: "DEN", silhouette: "M8,60 L8,38 L14,38 L14,30 L20,30 L20,22 L26,22 L26,18 L30,18 L30,22 L36,22 L36,30 L42,30 L42,38 L48,38 L48,60 Z" },
  { name: "Las Vegas", abbr: "LAS", silhouette: "M10,60 L10,36 L16,36 L16,26 L20,26 L20,20 L24,20 L24,14 L28,14 L28,10 L32,10 L32,14 L36,14 L36,20 L40,20 L40,26 L44,26 L44,36 L50,36 L50,60 Z" },
  { name: "Houston", abbr: "HOU", silhouette: "M8,60 L8,44 L16,44 L16,36 L22,36 L22,30 L30,30 L30,36 L38,36 L38,30 L46,30 L46,36 L52,36 L52,44 L60,44 L60,60 Z" },
  { name: "San Antonio", abbr: "SAT", silhouette: "M10,60 L10,42 L16,42 L16,34 L22,34 L22,28 L28,28 L28,22 L34,22 L34,28 L40,28 L40,34 L46,34 L46,42 L52,42 L52,60 Z" },
  { name: "Miami", abbr: "MIA", silhouette: "M12,60 L12,42 L18,42 L18,34 L22,34 L22,26 L28,26 L28,20 L34,20 L34,26 L40,26 L40,34 L44,34 L44,42 L50,42 L50,60 Z" },
  { name: "Toronto", abbr: "YYZ", silhouette: "M8,60 L8,36 L14,36 L14,28 L20,28 L20,20 L26,20 L26,14 L30,14 L30,10 L34,10 L34,14 L38,14 L38,20 L44,20 L44,28 L50,28 L50,36 L56,36 L56,60 Z" },
  { name: "Montreal", abbr: "YUL", silhouette: "M10,60 L10,38 L16,38 L16,30 L22,30 L22,22 L28,22 L28,16 L34,16 L34,22 L40,22 L40,30 L46,30 L46,38 L52,38 L52,60 Z" },
];
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3">
            {expansionCities.map((city, i) => (
              <motion.div
                ...
                className="group relative bg-background border border-border rounded-xl p-4 cursor-pointer hover:border-primary hover:shadow-lg transition-all duration-300 overflow-hidden"
              >
                {/* Silhouette SVG */}
                <div className="flex justify-center mb-3 opacity-20 group-hover:opacity-40 transition-opacity duration-300">
                  <svg viewBox="0 0 70 65" className="w-12 h-10 fill-foreground group-hover:fill-primary transition-colors duration-300">
                    <path d={city.silhouette} />
                  </svg>
                </div>

                <p className="font-display font-bold text-foreground text-sm text-center leading-tight group-hover:text-primary transition-colors duration-300">
                  {city.name}
                </p>
                <p className="text-muted-foreground text-xs text-center mt-0.5 font-mono">{city.abbr}</p>

                {/* Tooltip */}
                <div className="absolute inset-0 bg-secondary/95 rounded-xl flex flex-col items-center justify-center p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                  <p className="font-display text-secondary-foreground font-bold text-xs text-center mb-2 leading-tight">
                    Experience the<br />Guides Directly Playbook
                  </p>
                  <div className="space-y-1">
                    {["Verified Guides", "Zero Commissions"].map((item) => (
                      <div key={item} className="flex items-center gap-1.5">
                        <CheckCircle2 className="w-3 h-3 text-primary flex-shrink-0" />
                        <span className="text-primary text-[10px] font-semibold">{item}</span>
                      </div>
                    ))}
                  </div>
                </div>

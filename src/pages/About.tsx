            ...
            <div className="grid lg:grid-cols-[auto,1fr] gap-12 lg:gap-16 items-center max-w-5xl mx-auto">
              <motion.div {...fadeUp} className="flex justify-center lg:justify-start">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-2 -right-2 bg-background border border-primary/30 rounded-full px-4 py-2 shadow-lg">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {values.map((v, i) => (
                <motion.div
                  ...
                  className="p-7 rounded-2xl bg-card border border-border shadow-card hover:border-primary/40 transition-colors"
                >
            ...
            <motion.div {...fadeUp} className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid sm:grid-cols-3 gap-4 mb-10">
                {["Washington DC", "Chicago", "Los Angeles"].map((city) => (
                  <div
                    key={city}
                    className="p-5 rounded-xl bg-background border border-border flex items-center justify-center gap-2"
                  >

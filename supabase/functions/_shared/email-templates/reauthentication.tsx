...
const code = { fontSize: '36px', fontWeight: '700' as const, letterSpacing: '8px', color: '#0891b2', textAlign: 'center' as const, margin: '24px 0', padding: '16px', backgroundColor: '#f0f9ff', borderRadius: '8px' };

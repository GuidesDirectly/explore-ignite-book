...
export default function InviteEmail({ siteName = 'iGuide Tours', siteUrl = 'https://iguidetours.net', confirmationUrl = '', recipient = '' }: InviteEmailProps) {
  return (
    <Html>
      <Head>
        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              You've been invited to join {siteName} — discover personalized tours led by local guides who know every hidden gem.
            </Text>

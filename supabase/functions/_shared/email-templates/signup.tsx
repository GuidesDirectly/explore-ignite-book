...
export default function SignupEmail({ siteName = 'iGuide Tours', siteUrl = 'https://iguidetours.net', confirmationUrl = '', recipient = '' }: SignupEmailProps) {
  return (
    <Html>
      <Head>
        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Thanks for joining — you're one step away from discovering incredible tours led by local guides who know every hidden gem.
            </Text>
